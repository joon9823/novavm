...
func (obj *AccountAddress) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_array20_u8_array((([20]uint8)(*obj)), serializer); err != nil { return err }
...
func DeserializeAccountAddress(deserializer serde.Deserializer) (AccountAddress, error) {
	...
	if val, err := deserialize_array20_u8_array(deserializer); err == nil { obj = val } else { return ((AccountAddress)(obj)), err }
...
func (obj *ContractEvent) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := serializer.SerializeBytes(obj.Key); err != nil { return err }
...
func DeserializeContractEvent(deserializer serde.Deserializer) (ContractEvent, error) {
	...
	if val, err := deserializer.DeserializeBytes(); err == nil { obj.Key = val } else { return obj, err }
...
func (obj *ExecutionResult) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := serialize_vector_u8(obj.Result, serializer); err != nil { return err }
	if err := serialize_vector_ContractEvent(obj.Events, serializer); err != nil { return err }
	if err := serialize_vector_SizeDelta(obj.SizeDeltas, serializer); err != nil { return err }
...
func DeserializeExecutionResult(deserializer serde.Deserializer) (ExecutionResult, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserialize_vector_u8(deserializer); err == nil { obj.Result = val } else { return obj, err }
	if val, err := deserialize_vector_ContractEvent(deserializer); err == nil { obj.Events = val } else { return obj, err }
	if val, err := deserialize_vector_SizeDelta(deserializer); err == nil { obj.SizeDeltas = val } else { return obj, err }
...
func (obj *SizeDelta) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeBool(obj.IsDecreasing); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeSizeDelta(deserializer serde.Deserializer) (SizeDelta, error) {
	...
	if val, err := deserializer.DeserializeBool(); err == nil { obj.IsDecreasing = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func deserialize_vector_SizeDelta(deserializer serde.Deserializer) ([]SizeDelta, error) {
	...
	for i := range(obj) {
		if val, err := DeserializeSizeDelta(deserializer); err == nil { obj[i] = val } else { return nil, err }
	}
	return obj, nil
}
